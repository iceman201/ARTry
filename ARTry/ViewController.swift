...
//  ARTry
//
//  Created by Liguo Jiao on 23/03/19.
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        // Object Detection
        configuration.detectionObjects = ARReferenceObject.referenceObjects(inGroupNamed: "AR_Resources", bundle: Bundle.main)!
